...
import com.yaqubabbasov.bobofood.ui.adapter.ProductAdapter
import com.yaqubabbasov.bobofood.ui.viewmodel.HomeViewModel
...
class HomeFragment : Fragment() {
    ...
    private fun search() {
        ...
        val searchAdapter = ProductAdapter(requireContext(), emptyList())
